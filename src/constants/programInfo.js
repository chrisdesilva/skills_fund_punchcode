...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its program to prepare students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const hubspotFormId = "ae67b19b-50c4-4efa-9489-72777332f3f5" // create Hubspot form, get form id after publishing
