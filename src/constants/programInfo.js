...
export const faq = {
	...
	loanRange: [
		...
		{
			programName: "PunchCode's Part-Time Full Stack Software Engineering program",
			maxAmount: '$10,900',
			col: false,
			colAmount: '$3,000'
		}
...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its program to prepare students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
